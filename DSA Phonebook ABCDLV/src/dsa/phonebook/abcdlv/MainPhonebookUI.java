...
public class MainPhonebookUI extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainPhonebookUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
